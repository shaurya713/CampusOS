...
class User(Base):
    ...
    # Persist enum values ("student", "staff", "admin") rather than Python member names.
    # The initial PostgreSQL migration defines the enum with these lowercase values.
    role: Mapped[Role] = mapped_column(
        Enum(Role, name="user_role", values_callable=lambda enum: [member.value for member in enum]),
        nullable=False,
