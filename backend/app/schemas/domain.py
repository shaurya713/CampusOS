...
<<<<<<< HEAD
class StaffIn(BaseModel): full_name:str; email:str; phone:str|None=None; password:str=Field(min_length=8); government_id:str=Field(min_length=4,max_length=100); permanent_address:str=Field(min_length=10,max_length=500); profile_photo_url:str|None=None; employee_id:str; department_id:UUID|None=None; designation:str|None=None; specialization:list[str]=[]; service_area:str|None=None; max_active_complaints:int=10; experience_years:int=Field(default=0,ge=0,le=60); working_hours:str|None=None
